...
export const reference = firebase.database().ref('jobs');
// export const adminReference = firebase.database().ref('admins');
// export const speakerReference = firebase.database().ref('speakers');
// export const gearUpReference = firebase.database().ref('gearUp');
